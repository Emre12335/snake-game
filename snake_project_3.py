        ...
        if play_active:
            if event.type == pygame.KEYDOWN:
                if len(tail.tail_list) == 0:
                    ...
                    if event.key == pygame.K_w and a.movement[1] != "s" and tail.tail_list[-1].rect.bottom != a.rect.top:
                        a.movement = (-40, "w")
                    elif event.key == pygame.K_s and a.movement[1] != "w" and tail.tail_list[-1].rect.top != a.rect.bottom:
                        a.movement = (40, "s")
                    elif event.key == pygame.K_a and a.movement[1] != "d" and tail.tail_list[-1].rect.right != a.rect.left:
                        a.movement = (-40, "a")
                    elif event.key == pygame.K_d and a.movement[1] != "a" and tail.tail_list[-1].rect.left != a.rect.right:
                        a.movement = (40, "d")
        else:
            if event.type == pygame.KEYDOWN:
